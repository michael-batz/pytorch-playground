...
def main():
    ...
    train_data_loader = torch.utils.data.DataLoader(train_data, batch_size=ics.batch_size, shuffle=True)
    val_data_loader = torch.utils.data.DataLoader(val_data, batch_size=ics.batch_size, shuffle=True)
    test_data_loader = torch.utils.data.DataLoader(test_data, batch_size=ics.batch_size, shuffle=True)
